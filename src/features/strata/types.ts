...
export const STRATA_SECTIONS: StrataSection[] = [
  {
    id: 'words_you_own',
    title: '1. Words You Own (Mindshare)',
  ...
  {
    id: 'x_factor',
    title: '6. X-Factor (10x – 100x Underlying Advantage)',
    description: 'What gives you a significant (10x or more) advantage over others',
    type: 'text'
  },
  {
    id: 'profit_bhag',
    title: '7. Profit per X & BHAG (Economic Engine & Long-Term Goal)',
